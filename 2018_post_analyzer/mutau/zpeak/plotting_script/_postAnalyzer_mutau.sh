...
./_postAnalyzer_mutau.exe ../files_initial/DYJetsToLL_M10to50_final.root files_nominal/DYJetsToLL_M10to50_final.root DYJetsToLL_M10to50 DYJetsToLL_M10to50 0 
...
./_postAnalyzer_mutau.exe ../files_initial/WJetsToLNu_final.root files_nominal/WJetsToLNu_stitch_final.root WJets_inc WJets_jets 0 
