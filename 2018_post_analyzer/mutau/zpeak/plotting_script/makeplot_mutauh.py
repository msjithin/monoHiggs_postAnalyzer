...
DYJetsToLL_M10to50_hist =OutFile.Get(dirname[0]+"DYJetsToLL_M10to50_"+histoname)
...
ZTT_hist.Add(DYJetsToLL_M10to50_hist)
...
if yaxisLog == 0 :
  ...
  c.SaveAs("plots/plot_"+histoname+"_"+channel_+"_logY.png")
