...
./analyze_mutau /hdfs/store/user/jmadhusu/2018_skimmed/mutau/mc/DY1JetsToLL_00.root DY1JetsToLL_00.root $nEvents 1000 2018_test MC DY1JetsToLL_00

outFile="study_mutau_wj.root"
echo "wjets sample analysis....."
./analyze_mutau /hdfs/store/user/jmadhusu/2018_skimmed/mutau/mc/WJetsToLNu_00.root WJetsToLNu_00.root $nEvents 1000 2018_test MC WJetsToLNu_00
outFile="study_mutau_data.root"
echo "data sample analysis....."
./analyze_mutau /hdfs/store/user/jmadhusu/2018_skimmed/mutau/data/SingleMuonA_00.root SingleMuonA_00.root $nEvents 1000 2018_test DATA SingleMuonA_00
