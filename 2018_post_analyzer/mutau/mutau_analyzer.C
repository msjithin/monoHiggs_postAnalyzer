...
void mutau_analyzer::fillHist( string histNumber , int muIndex, int tauIndex, float event_weight){
  ...
  plotFill("tauIso_"+hNumber, tau_IDbits->at(tauIndex)>>16&1==1, 4, -2, 2,  event_weight);
  ...
  plotFill("tauAntiEle_"+hNumber, tau_IDbits->at(tauIndex)>>4&1==1, 8, -2, 2,  event_weight );
  plotFill("tauAntiMu_"+hNumber,  tau_IDbits->at(tauIndex)>>3&1==1, 8, -2, 2 ,  event_weight);
