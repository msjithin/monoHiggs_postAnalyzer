...
int main(int argc, char** argv)
{
  ...
  else if (sample=="WJets_inc"){xs=LOtoNNLO_Wjets*50380.0;    weight=52.01898249;}
  else if (sample=="W1Jet")    {xs=LOtoNNLO_Wjets*9644.5;     weight=10.93401571;}
  else if (sample=="W2Jet")    {xs=LOtoNNLO_Wjets*3144.5;     weight=8.317497757;}
  else if (sample=="W3Jet")    {xs=LOtoNNLO_Wjets*964.8;      weight=4.417448717;}
  else if (sample=="W4Jet")    {xs=LOtoNNLO_Wjets*485.6;      weight=3.311191492;}
