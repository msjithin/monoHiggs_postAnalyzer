...
do 
    ...
    python makeplot.py -in $inFile -name $i -cat 0 -ch etau -xaxis $i -year 2018
    python makeplot_fbkg.py -in $inFile -name $i -cat 0 -ch etau -xaxis $i -year 2018
done
...
python makeplot.py -in $inFile -name cutflow_n -cat 0 -ch etau -xaxis "cutflow" -lY  -year 2018
