...
./_postAnalyzer_mutau.exe ../files_initial/Tau_EraB_final.root files_nominal/Tau_EraB_final.root data_obs data_obs 0 
./_postAnalyzer_mutau.exe ../files_initial/Tau_EraC_final.root files_nominal/Tau_EraC_final.root data_obs data_obs 0 
./_postAnalyzer_mutau.exe ../files_initial/Tau_EraD_final.root files_nominal/Tau_EraD_final.root data_obs data_obs 0 
./_postAnalyzer_mutau.exe ../files_initial/Tau_EraE_final.root files_nominal/Tau_EraE_final.root data_obs data_obs 0 
./_postAnalyzer_mutau.exe ../files_initial/Tau_EraF_final.root files_nominal/Tau_EraF_final.root data_obs data_obs 0 
