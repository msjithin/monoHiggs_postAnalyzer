...
std::vector<string>  plotList = {
  ...
  "elePt_5", "eleEta_5", "elePhi_5", "eleDz_5", "eleD0_5", "electronID_5", "relEleIso_5", "eleCharge_5", "tauPt_5", "tauEta_5", "tauPhi_5", "tauIso_5", "tauDecayMode_5", "tauCharge_5", "tauAntiEle_5", "tauAntiMu_5","deltaR_5", "higgsPt_5", "nJet_5",  "visMass_5", "mT_muMet_5",  "met_5",  "tot_TMass_5",
				 
 "elePt_5_fr", "eleEta_5_fr", "elePhi_5_fr", "eleDz_5_fr", "eleD0_5_fr", "electronID_5_fr", "relEleIso_5_fr", "eleCharge_5_fr", "tauPt_5_fr", "tauEta_5_fr", "tauPhi_5_fr", "tauIso_5_fr", "tauDecayMode_5_fr", "tauCharge_5_fr", "tauAntiEle_5_fr", "tauAntiMu_5_fr", "deltaR_5_fr", "higgsPt_5_fr", "nJet_5_fr", "visMass_5_fr", "mT_muMet_5_fr", "met_5_fr", "tot_TMass_5_fr",
				 
 "elePt_6", "eleEta_6", "elePhi_6", "eleDz_6", "eleD0_6", "electronID_6", "relEleIso_6", "eleCharge_6", "tauPt_6", "tauEta_6", "tauPhi_6", "tauIso_6", "tauDecayMode_6", "tauCharge_6", "tauAntiEle_6", "tauAntiMu_6","deltaR_6", "higgsPt_6", "nJet_6",  "visMass_6", "mT_muMet_6",  "met_6",  "tot_TMass_6",
				 
  "elePt_6_fr", "eleEta_6_fr", "elePhi_6_fr", "eleDz_6_fr", "eleD0_6_fr", "electronID_6_fr", "relEleIso_6_fr", "eleCharge_6_fr", "tauPt_6_fr", "tauEta_6_fr", "tauPhi_6_fr", "tauIso_6_fr", "tauDecayMode_6_fr", "tauCharge_6_fr", "tauAntiEle_6_fr", "tauAntiMu_6_fr", "deltaR_6_fr", "higgsPt_6_fr", "nJet_6_fr", "visMass_6_fr", "mT_muMet_6_fr", "met_6_fr", "tot_TMass_6_fr",
...
void make_hist(string input_file, string output_file, string histSaveName, string histname_string, string sample_name, TString directory_name ,  Double_t weight_lumi , bool isNLO)
{
  ...
  net_weight=net_weight*scale_factor;
...
int main(int argc, char** argv)
{
  ...
  else if (sample=="ZTTjet_inc"){ xs=LOtoNNLO_DY*4954.0; weight=2.4467;}
  else if (sample=="ZTT1jet"){ xs=LOtoNNLO_DY*1012.5; weight=0.785;}
  else if (sample=="ZTT2jet"){ xs=LOtoNNLO_DY*332.8; weight=0.9689;}
  else if (sample=="ZTT3jet"){ xs=LOtoNNLO_DY*101.8; weight=0.55;}
  else if (sample=="ZTT4jet"){ xs=LOtoNNLO_DY*54,8; weight=0.4891;}
  ...
  //make_hist(input, output, "muPt_6", sample, dirName, weight, true, ngen , xs);
