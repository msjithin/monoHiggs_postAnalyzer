...
sampleListDict = {
    ...
    'ee_SingleElectron_EraB' : ['data_obs', 'data_obs_dyll', '0'],
    'ee_SingleElectron_EraC' : ['data_obs', 'data_obs_dyll', '0'],
    'ee_SingleElectron_EraD' : ['data_obs', 'data_obs_dyll', '0'],
    'ee_SingleElectron_EraE' : ['data_obs', 'data_obs_dyll', '0'],
    'ee_SingleElectron_EraF' : ['data_obs', 'data_obs_dyll', '0'],
