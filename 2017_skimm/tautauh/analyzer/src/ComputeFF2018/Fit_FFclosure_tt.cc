...
TF1 *M_FR(int WP, std::string type, std::string files, std::string num, std::string denum, std::string name, TH2F * hist2D_lep, Double_t fMin, Double_t fMax, int year) {
    ...
    if (name.find("et_w") < 140) theFit = new TF1("theFit", fitFunc_Line3Par, fMin, fMax, 3);
...
void Fit_FFclosure_tt(int year) {
    ...
    TF1* m11 = M_FR(1, "Line2Par", "files_corr1FF_tt/DataSub.root", "tt_0jet_qcd_mvis_iso", "tt_0jet_qcd_mvis_anti", "closure_mvis_tt_qcd", Fit_Value_tau, fMin, fMax, year);
    TF1* m12 = M_FR(2, "Line2Par", "files_corr1FF_tt/DataSub.root", "tt_0SSloose_qcd_mvis_iso", "tt_0SSloose_qcd_mvis_anti", "closure_mvis_tt_qcdloose", Fit_Value_tau, fMin, fMax, year);
    TF1* m13 = M_FR(3, "Line2Par", "files_corr1FF_tt/DataSub.root", "tt_0jet_qcd_tau2pt_iso", "tt_0jet_qcd_tau2pt_anti", "closure_tau2pt_tt_qcd", Fit_Value_tau, fMin, fMax, year);
    TF1* m14 = M_FR(4, "Line2Par", "files_corr1FF_tt/DataSub.root", "tt_0SSloose_qcd_tau2pt_iso", "tt_0SSloose_qcd_tau2pt_anti", "closure_tau2pt_tt_qcdloose", Fit_Value_tau, fMin, fMax, year);
    TF1* m15 = M_FR(5, "Line2Par", "files_corr1FF_tt/DataSub.root", "tt_0jet_qcd_tau1pt_iso", "tt_0jet_qcd_tau1pt_anti", "closure_tau1pt_tt_qcd", Fit_Value_tau, fMin, fMax, year);
    TF1* m16 = M_FR(6, "Line2Par", "files_corr1FF_tt/DataSub.root", "tt_0SSloose_qcd_tau1pt_iso", "tt_0SSloose_qcd_tau1pt_anti", "closure_tau1pt_tt_qcdloose", Fit_Value_tau, fMin, fMax, year);
    TF1* m17 = M_FR(7, "Line2Par", "files_corr1FF_tt/DataSub.root", "tt_0jet_qcd_met_iso", "tt_0jet_qcd_met_anti", "closure_met_tt_qcd", Fit_Value_tau, fMin, fMax, year);
    TF1* m18 = M_FR(8, "Line2Par", "files_corr1FF_tt/DataSub.root", "tt_0SSloose_qcd_met_iso", "tt_0SSloose_qcd_met_anti", "closure_met_tt_qcdloose", Fit_Value_tau, fMin, fMax, year);
