...
inputDrMC="/hdfs/store/user/jmadhusu/2017_skimmed/tautau/"
...
for j in filelistMC :
    if 'Tau_Era' in j or '.root' not in j:
        continue
   # outFile.write("./MakeCondorFiles.csh analyze_tautau_MC "+inputDrMC+j+" "+"files_initial/"+j+" -1 1000 2018_test MC "+j[:-5]+"\n")
    outFile.write("./MakeCondorFiles.csh analyze_tautau "+inputDrMC+j+" "+j+" -1 1000 2017 MC "+j[:-5]+" $outDir"+"\n")
        

inputDrDATA="/hdfs/store/user/jmadhusu/2017_skimmed/tautau/"
...
for j in filelistDATA :
    if 'Tau_Era' in j:
        #outFile.write("./MakeCondorFiles.csh analyze_tautau_data "+inputDrDATA+j+" "+"files_initial/"+j+" -1 1000 2018_test DATA "+j[:-5]+"\n")
