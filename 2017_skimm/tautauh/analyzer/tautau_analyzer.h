...
public :
   ...
   TFile *f_tauFR=new TFile("sf_files/tauHtauH/fake_factors.root");
   TH1F *h_tauFR_0=(TH1F*) f_tauFR->Get("ratio_decay_0");
   TH1F *h_tauFR_1=(TH1F*) f_tauFR->Get("ratio_decay_0");
   TH1F *h_tauFR_10=(TH1F*) f_tauFR->Get("ratio_decay_0");
  ...
  // Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   tautau_analyzer(const char* file1, const char* file2, string isMC);
   virtual ~tautau_analyzer();
   ...
   virtual vector<int> getTau2Cand(double pt, double eta, int tau1Index);
   virtual vector<int> getAISRTau2Cand(double pt, double eta, int tau1Index);
   ...
   virtual void fillHist( string histNumber, int tau1Index, int tau2Index, float event_weight);
   virtual void fillHist( string histNumber, TLorentzVector tau1P4, TLorentzVector tau2P4, int tau1Index, int tau2Index, float event_weight);
   ...
   virtual double getScaleFactors( int tau1Index , int tau2Index,  bool fakeBkg , bool isMC, bool debug);
...
tautau_analyzer::tautau_analyzer(const char* file1, const char* file2, string isMC)
{
...
void tautau_analyzer::Init(TChain *tree, string _isMC_)
{
