...
#ifndef calc_FR_2017_h
#define calc_FR_2017_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //   calc_FR_2017(TTree *tree=0);
   calc_FR_2017(const char* file1, const char* file2, string isMC);
   virtual ~calc_FR_2017();
...
#ifdef calc_FR_2017_cxx
calc_FR_2017::calc_FR_2017(const char* file1, const char* file2, string isMC)
{
...
Int_t calc_FR_2017::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t calc_FR_2017::LoadTree(Long64_t entry)
{
...
void calc_FR_2017::Init(TChain *tree, string _isMC_)
{
...
void calc_FR_2017::Show(Long64_t entry)
{
...
Int_t calc_FR_2017::Cut(Long64_t entry)
{
