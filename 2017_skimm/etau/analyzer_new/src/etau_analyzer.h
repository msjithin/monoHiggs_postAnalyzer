...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void     Loop_et(Long64_t maxEvents, int reportEvery, string SampleName, string _isMC_);
   virtual void     Loop_ee(Long64_t maxEvents, int reportEvery, string SampleName, string _isMC_);
