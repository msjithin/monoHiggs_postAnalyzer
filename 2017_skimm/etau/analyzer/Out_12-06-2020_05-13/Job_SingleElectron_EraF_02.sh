...
./analyze_etau /hdfs/store/user/jmadhusu/2017_skimmed/etau/SingleElectron_EraF_02.root SingleElectron_EraF_02.root -1 1000 2017 DATA SingleElectron_EraF_02
