...
./analyze_etau /hdfs/store/user/jmadhusu/2017_skimmed/etau/SingleElectron_EraE_03.root SingleElectron_EraE_03.root -1 1000 2017 DATA SingleElectron_EraE_03
