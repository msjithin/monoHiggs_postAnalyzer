...
public:
  ...
  applyFF_w_lpt(){
    ...
    frawff = TFile::Open("sf_files/FF_lptCorrInBinsOfTauPt/ff_files_et_2017/uncorrected_fakefactors_et.root");
    ...
    fmvisclosure = TFile::Open("sf_files/FF_lptCorrInBinsOfTauPt/ff_files_et_2017/FF_corrections_1.root");
    ...
    fosssclosure  = TFile::Open("sf_files/FF_lptCorrInBinsOfTauPt/ff_files_et_2017/FF_QCDcorrectionOSSS.root");
