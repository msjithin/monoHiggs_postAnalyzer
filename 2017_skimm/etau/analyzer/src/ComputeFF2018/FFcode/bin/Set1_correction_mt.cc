...
int main(int argc, char** argv) {
   ...
   float bins_mtt0[] = {50,60,70,80,90,100,110,120,130,140,150,160,170,180,190,200,250};
   ...
   TF1* ff_looseSSqcd_2jet=(TF1*) frawff.Get("rawFF_mt_qcd_2jetSSloose");
   ...
   TF1* mvisclosure_qcd0=(TF1*) fmvisclosure.Get("closure_mvis_mt_0jet_qcd");
   TF1* mvisclosure_w0=(TF1*) fmvisclosure.Get("closure_mvis_mt_0jet_w");
   TF1* mvisclosure_qcd1=(TF1*) fmvisclosure.Get("closure_mvis_mt_1jet_qcd");
	...
	*/
	...
	//************************* Fill histograms **********************
	  ...
	  if (njets==1) ff_qcd=get_raw_FF(mytau.Pt(),ff_qcd_1jet);
          if (njets>1) ff_qcd=get_raw_FF(mytau.Pt(),ff_qcd_2jet);
          ...
          if (njets>1) ff_looseSSqcd=get_raw_FF(mytau.Pt(),ff_looseSSqcd_2jet);
	  ...
	  if (name=="WMC"){
	     ff_w=get_raw_FF(mytau.Pt(),ff_wmc_0jet);
             ...
             if (njets>1) ff_w=get_raw_FF(mytau.Pt(),ff_wmc_2jet);
	     mt=100;
	  }
          ...
          if (name=="WMC2"){
             ...
             if (njets==1) ff_w=get_raw_FF(mytau.Pt(),ff_wmc_1jet)*get_mvis_closure((mymu+mytau).M(),mvisclosure_wmc);
             if (njets>1) ff_w=get_raw_FF(mytau.Pt(),ff_wmc_2jet)*get_mvis_closure((mymu+mytau).M(),mvisclosure_wmc);
          }
           ...
           if (!is_includedInEmbedded){
             ...
             if (isL or isT){
               ...
               if (signalRegion && iso_1>0.02 && iso_1<0.15 && nbtag==0 && mt<50 && q_1*q_2>0){
                  ...
                  if (njets>1 && mjj>350 && (mymu+mytau+mymet).Pt()>200) h0LT_qcd_catvbfhigh_iso->Fill(mjj,m_sv,aweight*weight2);
               }
               if (antiisoRegion && iso_1>0.02 && iso_1<0.15 && nbtag==0 && mt<50 && q_1*q_2>0){
                  ...
                  if (njets>1 && mjj>350 && (mymu+mytau+mymet).Pt()>200) h0LT_qcd_catvbfhigh_anti->Fill(mjj,m_sv,aweight*weight2*ff_qcd);
               }
               ...
               if (signalRegion && iso_1<0.15 && nbtag==0 && mt>70 && q_1*q_2<0){
                  ...
                  if (njets>1 && mjj>350 && (mymu+mytau+mymet).Pt()>200) h0LT_w_catvbfhigh_iso->Fill(mjj,m_sv,aweight*weight2);
               }
               if (antiisoRegion && iso_1<0.15 && nbtag==0 && mt>70 && q_1*q_2<0){
                  ...
                  if (njets>1 && mjj>350 && (mymu+mytau+mymet).Pt()>200) h0LT_w_catvbfhigh_anti->Fill(mjj,m_sv,aweight*weight2*ff_w);
               }
               ...
               if (signalRegion && iso_1>0.02 && iso_1<0.15 && nbtag==0 && mt<50 && q_1*q_2>0){
                  ...
                  if (njets>1 && mjj>350 && (mymu+mytau+mymet).Pt()>200) h0J_qcd_catvbfhigh_iso->Fill(mjj,m_sv,aweight*weight2);
               ...
               if (antiisoRegion && iso_1>0.02 && iso_1<0.15 && nbtag==0 && mt<50 && q_1*q_2>0){
                  ...
                  if (njets>1 && mjj>350 && (mymu+mytau+mymet).Pt()>200) h0J_qcd_catvbfhigh_anti->Fill(mjj,m_sv,aweight*weight2*ff_qcd);
               }
               ...
               if (signalRegion && iso_1<0.15 && nbtag==0 && mt>70 && q_1*q_2<0){
                  ...
                  if (njets>1 && mjj>350 && (mymu+mytau+mymet).Pt()>200) h0J_w_catvbfhigh_iso->Fill(mjj,m_sv,aweight*weight2);
               ...
               if (antiisoRegion && iso_1<0.15 && nbtag==0 && mt>70 && q_1*q_2<0){
                  ...
                  if (njets>1 && mjj>350 && (mymu+mytau+mymet).Pt()>200) h0J_w_catvbfhigh_anti->Fill(mjj,m_sv,aweight*weight2*ff_w);
    ...
    TDirectory *d0_qcd_mvis_iso =fout->mkdir("mt_0jet_qcd_mvis_iso");
    d0_qcd_mvis_iso->cd();
    ...
    TDirectory *d0_qcd_mvis_anti =fout->mkdir("mt_0jet_qcd_mvis_anti");
    d0_qcd_mvis_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d1_qcd_mvis_iso =fout->mkdir("mt_1jet_qcd_mvis_iso");
    d1_qcd_mvis_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d1_qcd_mvis_anti =fout->mkdir("mt_1jet_qcd_mvis_anti");
    d1_qcd_mvis_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d2_qcd_mvis_iso =fout->mkdir("mt_2jet_qcd_mvis_iso");
    d2_qcd_mvis_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d2_qcd_mvis_anti =fout->mkdir("mt_2jet_qcd_mvis_anti");
    d2_qcd_mvis_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_qcd_taupt_iso =fout->mkdir("mt_0jet_qcd_taupt_iso");
    d0_qcd_taupt_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_qcd_taupt_anti =fout->mkdir("mt_0jet_qcd_taupt_anti");
    ...
    TDirectory *d0_qcd_pth_anti =fout->mkdir("mt_0jet_qcd_pth_anti");
    d0_qcd_pth_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_qcd_mjj_iso =fout->mkdir("mt_0jet_qcd_mjj_iso");
    d0_qcd_mjj_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_qcd_mjj_anti =fout->mkdir("mt_0jet_qcd_mjj_anti");
    d0_qcd_mjj_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_qcd_cat0jetlow_iso =fout->mkdir("mt_0jet_qcd_cat0jetlow_iso");
    ...
    TDirectory *d0_qcd_cat0jetlow_anti =fout->mkdir("mt_0jet_qcd_cat0jetlow_anti");
    ...
    TDirectory *d0_qcd_cat0jethigh_iso =fout->mkdir("mt_0jet_qcd_cat0jethigh_iso");
    ...
    TDirectory *d0_qcd_cat0jethigh_anti =fout->mkdir("mt_0jet_qcd_cat0jethigh_anti");
    ...
    TDirectory *d0_qcd_catboosted1_iso =fout->mkdir("mt_0jet_qcd_catboosted1_iso");
    ...
    TDirectory *d0_qcd_catboosted1_anti =fout->mkdir("mt_0jet_qcd_catboosted1_anti");
    ...
    TDirectory *d0_qcd_catboosted2_iso =fout->mkdir("mt_0jet_qcd_catboosted2_iso");
    ...
    TDirectory *d0_qcd_catboosted2_anti =fout->mkdir("mt_0jet_qcd_catboosted2_anti");
    ...
    TDirectory *d0_qcd_catvbflow_iso =fout->mkdir("mt_0jet_qcd_catvbflow_iso");
    ...
    TDirectory *d0_qcd_catvbflow_anti =fout->mkdir("mt_0jet_qcd_catvbflow_anti");
    ...
    TDirectory *d0_qcd_catvbfhigh_iso =fout->mkdir("mt_0jet_qcd_catvbfhigh_iso");
    ...
    TDirectory *d0_qcd_catvbfhigh_anti =fout->mkdir("mt_0jet_qcd_catvbfhigh_anti");
    ...
    TDirectory *d0_w_mvis_iso =fout->mkdir("mt_0jet_w_mvis_iso");
    d0_w_mvis_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_w_mvis_anti =fout->mkdir("mt_0jet_w_mvis_anti");
    d0_w_mvis_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d1_w_mvis_iso =fout->mkdir("mt_1jet_w_mvis_iso");
    d1_w_mvis_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d1_w_mvis_anti =fout->mkdir("mt_1jet_w_mvis_anti");
    d1_w_mvis_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d2_w_mvis_iso =fout->mkdir("mt_2jet_w_mvis_iso");
    d2_w_mvis_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d2_w_mvis_anti =fout->mkdir("mt_2jet_w_mvis_anti");
    d2_w_mvis_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_w_taupt_iso =fout->mkdir("mt_0jet_w_taupt_iso");
    d0_w_taupt_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_w_taupt_anti =fout->mkdir("mt_0jet_w_taupt_anti");
    d0_w_taupt_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_w_pth_anti =fout->mkdir("mt_0jet_w_pth_anti");
    d0_w_pth_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_w_mjj_iso =fout->mkdir("mt_0jet_w_mjj_iso");
    d0_w_mjj_iso->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_w_mjj_anti =fout->mkdir("mt_0jet_w_mjj_anti");
    d0_w_mjj_anti->cd();
    if (sample=="data_obs" or sample=="W"){
    ...
    TDirectory *d0_w_cat0jetlow_iso =fout->mkdir("mt_0jet_w_cat0jetlow_iso");
    ...
    TDirectory *d0_w_cat0jetlow_anti =fout->mkdir("mt_0jet_w_cat0jetlow_anti");
    ...
    TDirectory *d0_w_cat0jethigh_iso =fout->mkdir("mt_0jet_w_cat0jethigh_iso");
    ...
    TDirectory *d0_w_cat0jethigh_anti =fout->mkdir("mt_0jet_w_cat0jethigh_anti");
    ...
    TDirectory *d0_w_catboosted1_iso =fout->mkdir("mt_0jet_w_catboosted1_iso");
    ...
    TDirectory *d0_w_catboosted1_anti =fout->mkdir("mt_0jet_w_catboosted1_anti");
    ...
    TDirectory *d0_w_catboosted2_iso =fout->mkdir("mt_0jet_w_catboosted2_iso");
    ...
    TDirectory *d0_w_catboosted2_anti =fout->mkdir("mt_0jet_w_catboosted2_anti");
    ...
    TDirectory *d0_w_catvbflow_iso =fout->mkdir("mt_0jet_w_catvbflow_iso");
    ...
    TDirectory *d0_w_catvbflow_anti =fout->mkdir("mt_0jet_w_catvbflow_anti");
    ...
    TDirectory *d0_w_catvbfhigh_iso =fout->mkdir("mt_0jet_w_catvbfhigh_iso");
    ...
    TDirectory *d0_w_catvbfhigh_anti =fout->mkdir("mt_0jet_w_catvbfhigh_anti");
