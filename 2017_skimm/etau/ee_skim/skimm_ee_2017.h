...
#ifndef skimm_ee_2017_h
#define skimm_ee_2017_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //   skimm_ee_2017(TTree *tree=0);
   skimm_ee_2017(const char* file1, const char* file2, string isMC);
   virtual ~skimm_ee_2017();
   ...
   virtual vector<int> skimmed_Ele2(int ele1Index);
   virtual vector<int> skimmed_Tau();
   virtual void fillOutTree();
   virtual double DeltaPhi(double phi1, double phi2);
   virtual double dR(int ele_index, int tau_index);
   virtual double dR_ee(int ele1index, int ele2index);
};

#endif

#ifdef skimm_ee_2017_cxx
skimm_ee_2017::skimm_ee_2017(const char* file1, const char* file2, string isMC)
{
...
Int_t skimm_ee_2017::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t skimm_ee_2017::LoadTree(Long64_t entry)
{
...
void skimm_ee_2017::Init(TChain *tree, string _isMC_)
{
...
void skimm_ee_2017::Show(Long64_t entry)
{
...
Int_t skimm_ee_2017::Cut(Long64_t entry)
{
