...
#ifndef skimm_mt_2017_h
#define skimm_mt_2017_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //   skimm_mt_2017(TTree *tree=0);
   skimm_mt_2017(const char* file1, const char* file2, string isMC);
   virtual ~skimm_mt_2017();
...
#ifdef skimm_mt_2017_cxx
skimm_mt_2017::skimm_mt_2017(const char* file1, const char* file2, string isMC)
{
...
Int_t skimm_mt_2017::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t skimm_mt_2017::LoadTree(Long64_t entry)
{
...
void skimm_mt_2017::Init(TChain *tree, string _isMC_)
{
...
void skimm_mt_2017::Show(Long64_t entry)
{
...
Int_t skimm_mt_2017::Cut(Long64_t entry)
{
