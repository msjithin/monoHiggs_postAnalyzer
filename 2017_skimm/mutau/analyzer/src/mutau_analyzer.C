...
double mutau_analyzer::getScaleFactors(  double mupt, double taupt, double mueta, double taueta, int taudm, int tauGenMatch, bool isFakebkg)
{
  ...
  double sf_htt_workspace=  m_tracking *  mu_singletrg * mu_crosstrg;// * zptmass_weight;
  // if(mupt<28.0)
  // {
  ...
  //   printTabSeparated("tau stuff", tau_crossttrg, t_deepid);
  //   printTabSeparated("general stuff",sf_htt_workspace,higgPt_weight,weight_btagSF,top_pt_weight);
  //   printTabSeparated("sf_muTrg", sf_muTrg);
  ...
  //   printTabSeparated("muon stuff",m_tracking,m_IDiso,mu_singletrg,mu_crosstrg,zptmass_weight);
  //   printTabSeparated("muon id",sf_muID , sf_IsoEff, sf_muID*sf_IsoEff,"\n");
  ...
  //double sf_htt_workspace=  m_tracking * m_IDiso * mu_singletrg * mu_crosstrg;// * zptmass_weight;
  //double sf_htt_workspace=  m_tracking *  mu_singletrg * mu_crosstrg;// * zptmass_weight;
  //rv_sf = sf_tauidSF_m * sf_tauTrg * sf_fakeEle * sf_fakeMu * sf_htt_workspace * higgPt_weight  ;
  rv_sf = sf_tauidSF_m * sf_tauTrg * sf_fakeEle * sf_fakeMu * sf_htt_workspace * higgPt_weight * top_pt_weight  ;
