...
// Sun Jun 14 05:32:26 2020 by ROOT version 6.12/07
// from TTree eventTree/event tree for analysis
// found on file: /hdfs/store/user/jmadhusu/MC2017_12Apr2018_monoHiggs_09Jun2020/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/crab_job_DYJetsToLL_M-50_TuneCP5_ext1_v1/200609_002427/0000/Ntuple_mc_11.root
//////////////////////////////////////////////////////////
...
#ifdef org_cxx
org::org(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/hdfs/store/user/jmadhusu/MC2017_12Apr2018_monoHiggs_09Jun2020/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/crab_job_DYJetsToLL_M-50_TuneCP5_ext1_v1/200609_002427/0000/Ntuple_mc_11.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/hdfs/store/user/jmadhusu/MC2017_12Apr2018_monoHiggs_09Jun2020/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/crab_job_DYJetsToLL_M-50_TuneCP5_ext1_v1/200609_002427/0000/Ntuple_mc_11.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/hdfs/store/user/jmadhusu/MC2017_12Apr2018_monoHiggs_09Jun2020/DYJetsToLL_M-50_TuneCP5_13TeV-madgraphMLM-pythia8/crab_job_DYJetsToLL_M-50_TuneCP5_ext1_v1/200609_002427/0000/Ntuple_mc_11.root:/phoJetNtuplizer");
...
Int_t org::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t org::LoadTree(Long64_t entry)
{
