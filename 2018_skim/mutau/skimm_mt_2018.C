...
bool skimm_mt_2018::skimming_Htt(){
  bool tmpCand=false;
...
std::vector<int> skimm_mt_2018::skimmed_Mu(){
...
std::vector<int> skimm_mt_2018::skimmed_Tau(){
  std::vector<int> tmpCand;    tmpCand.clear();
  for(int iTau=0; iTau<nTau;iTau++){
...
void skimm_mt_2018::fillOutTree(){
  run_ = run;
  event_= event;
  lumis_=lumis;
  tree->Fill();
...
double skimm_mt_2018::dR(int mu_index, int tau_index)
{
