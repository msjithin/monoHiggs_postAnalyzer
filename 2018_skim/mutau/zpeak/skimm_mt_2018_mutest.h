...
#ifndef skimm_mt_2018_mutest_h
#define skimm_mt_2018_mutest_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //   skimm_mt_2018_mutest(TTree *tree=0);
   skimm_mt_2018_mutest(const char* file1, const char* file2, string isMC);
   virtual ~skimm_mt_2018_mutest();
...
#ifdef skimm_mt_2018_mutest_cxx
skimm_mt_2018_mutest::skimm_mt_2018_mutest(const char* file1, const char* file2, string isMC)
{
...
skimm_mt_2018_mutest::~skimm_mt_2018_mutest()
{
   if (!fChain) return;
...
Int_t skimm_mt_2018_mutest::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t skimm_mt_2018_mutest::LoadTree(Long64_t entry)
{
...
void skimm_mt_2018_mutest::Init(TChain *tree, string _isMC_)
{
  ...
  cout<<"from Init "<<isMC<<endl;
   ...
   for (auto activeBranchName : {"run", "event", "lumis", "isData", "nVtx", "vtxX", "vtxY","vtxZ","vtxNtrks","vtx_isFake","vtx_ndof","vtx_rho","isGoodVtx","nGoodVtx","rho","rhoCentral","HLTEleMuX","HLTEleMuXIsPrescaled", "HLTEleMuXRejectedByPS","HLTPho","HLTPhoIsPrescaled","HLTPhoRejectedByPS","HLTTau","HLTTauIsPrescaled","HLTTauRejectedByPS","HLTMet","HLTMetIsPrescaled","HLTMetRejectedByPS","HLTJet","HLTJetIsPrescaled","HLTJetRejectedByPS","nMu","muPt","muE","muEta","muPhi","muCharge","muType","muIDbit","muD0","muDz","muSIP","muChi2NDF","muInnerD0","muInnerDz","muTrkLayers","muPixelLayers","muPixelHits","muMuonHits","muStations","muMatches","muTrkQuality","muInnervalidFraction","muIsoTrk","muPFChIso","muPFPhoIso","muPFNeuIso","muPFPUIso","musegmentCompatibility","muchi2LocalPosition","mutrkKink","muBestTrkPtError","muBestTrkPt","muBestTrkType","muFiredTrgs","muFiredL1Trgs","metFilters"  }) {
     fChain->SetBranchStatus(activeBranchName, 1);
   }
   if(isMC=="MC"){
     for (auto activeBranchName : {"genWeight","genHT","nMC","mcPID","mcPt","mcPhi","mcEta","mcE","mcStatus","mcStatusFlag","mcIndex","mcCharge","mcDaughterPID","genMatch2"  }) {
       fChain->SetBranchStatus(activeBranchName, 1);
     }
   }
...
Bool_t skimm_mt_2018_mutest::Notify()
{
...
void skimm_mt_2018_mutest::Show(Long64_t entry)
{
...
Int_t skimm_mt_2018_mutest::Cut(Long64_t entry)
{
...
#endif // #ifdef skimm_mt_2018_mutest_cxx
