...
#ifndef ref_mutau_analyzer_h
#define ref_mutau_analyzer_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //   ref_mutau_analyzer(TTree *tree=0);
   ref_mutau_analyzer(const char* file1, const char* file2, string isMC);
   virtual ~ref_mutau_analyzer();
   ...
   virtual void fillHist( int histNumber, int muIndex, int tauIndex, float event_weight);
...
#ifdef ref_mutau_analyzer_cxx
ref_mutau_analyzer::ref_mutau_analyzer(const char* file1, const char* file2, string isMC)
{
...
ref_mutau_analyzer::~ref_mutau_analyzer()
{
   if (!fChain) return;
...
Int_t ref_mutau_analyzer::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ref_mutau_analyzer::LoadTree(Long64_t entry)
{
...
void ref_mutau_analyzer::Init(TChain *tree, string _isMC_)
{
...
Bool_t ref_mutau_analyzer::Notify()
{
...
void ref_mutau_analyzer::Show(Long64_t entry)
{
...
Int_t ref_mutau_analyzer::Cut(Long64_t entry)
{
...
#endif // #ifdef ref_mutau_analyzer_cxx
