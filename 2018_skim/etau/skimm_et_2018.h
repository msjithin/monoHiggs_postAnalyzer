...
#ifndef skimm_et_2018_h
#define skimm_et_2018_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //   skimm_et_2018(TTree *tree=0);
   skimm_et_2018(const char* file1, const char* file2, string isMC);
   virtual ~skimm_et_2018();
...
#ifdef skimm_et_2018_cxx
skimm_et_2018::skimm_et_2018(const char* file1, const char* file2, string isMC)
{
...
Int_t skimm_et_2018::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t skimm_et_2018::LoadTree(Long64_t entry)
{
...
void skimm_et_2018::Init(TChain *tree, string _isMC_)
{
...
void skimm_et_2018::Show(Long64_t entry)
{
...
Int_t skimm_et_2018::Cut(Long64_t entry)
{
