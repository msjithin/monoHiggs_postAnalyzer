...
void smhet_2017::Loop(Long64_t maxEvents, int reportEvery, string SampleName, string _isMC_)
{
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     ...
     bool selectTrgMu24=(passMu24 && matchMu24_1 && filterMu24_1 && pt_1>25 && abs(eta_1)<2.1);
     bool selectTrgMu27=(passMu27 && matchMu27_1 && filterMu27_1 && pt_1>28 && abs(eta_1)<2.1);
     bool selectTrgCross=(passMu20Tau27 && matchMu20Tau27_1 && matchMu20Tau27_2  
			  && filterMu20Tau27_1 && filterMu20Tau27_2
			  && pt_1>21 && pt_1<=25 && pt_2>32 && abs(eta_1)<2.1 && abs(eta_2)<2.1
			  );

     if(selectTrgMu27 || selectTrgMu24 || selectTrgCross )
       {
	 makeMyPlot("b", 0, 0, 0, eventWeight);
	  
	 if(pt_1>20 && fabs(eta_1)<2.1 && iso_1<0.15)
	   {
		...
		&& byVLooseDeepVSe_2>0.5 && byTightDeepVSmu_2>0.5 
...
void smhet_2017::makeMyPlot( string histNumber , int muIndex, int mu2Index, int tauIndex, float event_weight){
  string hNumber = histNumber;
  plotFill("muPt_"+hNumber,  pt_1 , 30 , 20 , 80,  event_weight);
  plotFill("muEta_"+hNumber, eta_1, 48, -2.4, 2.4,  event_weight);
  plotFill("muPhi_"+hNumber, phi_1, 30, -3.14, 3.14,  event_weight);
  ...
  if( passMu27 && matchMu27_1 && filterMu27_1 )  triggerBin4=4;
  if( passMu24 && matchMu24_1 && filterMu24_1 )  triggerBin3=3;
  //if( passEle27 && matchEle27_1 && filterEle27_1 )  triggerBin2=2;
  if( passMu20Tau27 && matchMu20Tau27_1 && matchMu20Tau27_2
      && filterMu20Tau27_1 && filterMu20Tau27_2) triggerBin1=1;
  if(triggerBin1>0)
  ...
  double mT_muMet = TMass_F( pt_1, phi_1, met, metphi  );
...
double smhet_2017::getScaleFactors( double mupt, double taupt, double mueta, double taueta, int taudm)
{
  double rv_sf=1.0;
  ...
  TLorentzVector my_muP4, my_tauP4, my_metP4;
  my_muP4.SetPtEtaPhiE(pt_1, eta_1, phi_1 , e_1);
