...
// Fixed size dimensions of array or collections stored in the TTree if any.
  ...
  //BTagCSV* btag_csv =  new BTagCSV("sf_files/RootFiles/btag/DeepCSV_94XSF_WP_V4_B_F.csv");
   ...
   Float_t         matchMu24_1;
   Float_t         matchMu27_1;
   Float_t         matchMu20Tau27_1;
   Float_t         matchMu20Tau27_2;
   Float_t         filterMu24_1;
   Float_t         filterMu27_1;
   Float_t         filterMu20Tau27_1;
   Float_t         filterMu20Tau27_2;
   Float_t         mjj;
   ...
   Float_t         genpt_2;
   Float_t         geneta_2;
   Float_t         matchEmbFilter_Mu20Tau27_1;
   Float_t         matchEmbFilter_Mu24_1;
   Float_t         matchEmbFilter_Mu27_1;
   Float_t         matchEmbFilter_Mu20Tau27_2;
   Float_t         m_sv;
   Float_t         m_sv_DOWN;
   Float_t         m_sv_UP;
   Float_t         m_sv_UESUp;
   Float_t         m_sv_UESDown;
   Float_t         m_sv_muonESUp;
   Float_t         m_sv_muonESDown;
   ...
   TBranch        *b_passMu24;   //!
   TBranch        *b_passMu27;   //!
   TBranch        *b_passMu20Tau27;   //!
   TBranch        *b_matchMu24_1;   //!
   TBranch        *b_matchMu27_1;   //!
   TBranch        *b_matchMu20Tau27_1;   //!
   TBranch        *b_matchMu20Tau27_2;   //!
   TBranch        *b_filterMu24_1;   //!
   TBranch        *b_filterMu27_1;   //!
   TBranch        *b_filterMu20Tau27_1;   //!
   TBranch        *b_filterMu20Tau27_2;   //!
   TBranch        *b_mjj;   //!
   ...
   TBranch        *b_genpt_2;   //!
   TBranch        *b_geneta_2;   //!
   TBranch        *b_matchEmbFilter_Mu20Tau27_1;   //!
   TBranch        *b_matchEmbFilter_Mu24_1;   //!
   TBranch        *b_matchEmbFilter_Mu27_1;   //!
   TBranch        *b_matchEmbFilter_Mu20Tau27_2;   //!
   TBranch        *b_m_sv;   //!
   TBranch        *b_m_sv_DOWN;   //!
   TBranch        *b_m_sv_UP;   //!
   TBranch        *b_m_sv_UESUp;   //!
   TBranch        *b_m_sv_UESDown;   //!
   TBranch        *b_m_sv_muonESUp;   //!
   TBranch        *b_m_sv_muonESDown;   //!
...
{
  TChain *chain = new TChain("mutau_tree");
...
void smhet_2017::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("passMu24", &passMu24, &b_passMu24);
   fChain->SetBranchAddress("passMu27", &passMu27, &b_passMu27);
   fChain->SetBranchAddress("passMu20Tau27", &passMu20Tau27, &b_passMu20Tau27);
   fChain->SetBranchAddress("matchMu24_1", &matchMu24_1, &b_matchMu24_1);
   fChain->SetBranchAddress("matchMu27_1", &matchMu27_1, &b_matchMu27_1);
   fChain->SetBranchAddress("matchMu20Tau27_1", &matchMu20Tau27_1, &b_matchMu20Tau27_1);
   fChain->SetBranchAddress("matchMu20Tau27_2", &matchMu20Tau27_2, &b_matchMu20Tau27_2);
   fChain->SetBranchAddress("filterMu24_1", &filterMu24_1, &b_filterMu24_1);
   fChain->SetBranchAddress("filterMu27_1", &filterMu27_1, &b_filterMu27_1);
   fChain->SetBranchAddress("filterMu20Tau27_1", &filterMu20Tau27_1, &b_filterMu20Tau27_1);
   fChain->SetBranchAddress("filterMu20Tau27_2", &filterMu20Tau27_2, &b_filterMu20Tau27_2);
   ...
   fChain->SetBranchAddress("matchEmbFilter_Mu20Tau27_1", &matchEmbFilter_Mu20Tau27_1, &b_matchEmbFilter_Mu20Tau27_1);
   fChain->SetBranchAddress("matchEmbFilter_Mu24_1", &matchEmbFilter_Mu24_1, &b_matchEmbFilter_Mu24_1);
   fChain->SetBranchAddress("matchEmbFilter_Mu27_1", &matchEmbFilter_Mu27_1, &b_matchEmbFilter_Mu27_1);
   fChain->SetBranchAddress("matchEmbFilter_Mu20Tau27_2", &matchEmbFilter_Mu20Tau27_2, &b_matchEmbFilter_Mu20Tau27_2);
   ...
   fChain->SetBranchAddress("m_sv_muonESUp", &m_sv_muonESUp, &b_m_sv_muonESUp);
   fChain->SetBranchAddress("m_sv_muonESDown", &m_sv_muonESDown, &b_m_sv_muonESDown);
