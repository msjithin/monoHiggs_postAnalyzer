   ...
   for (Long64_t jentry=0; jentry<nentriesToCheck;jentry++)
     {
       ...
       if( ( (HLTEleMuX>>61&1==1)  //HLT_Ele32_WPTight_Gsf_v
	     || (HLTEleMuX>>5&1==1)   //HLT_Ele35_WPTight_Gsf_v
	     ))
       	 passSingleTriggerPaths=true;  //
       
       if( HLTTau>>1&1==1 || HLTTau>>16&1==1 )      //HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTau30_eta2p1_CrossL1
		   ...
		   if( tauCand.size() >0 )
		     {
		       ...
		       //cout<<"Good Tau Passed"<<endl;
		       setMyEleTau(eleCand[0], tauCand[0]);
		       //cout<<"elept : "<<my_eleP4.Pt()<<" taupt:"<<   my_tauP4.Pt() <<endl;
