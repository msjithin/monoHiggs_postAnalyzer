...
public :
  ...
  Int_t           run;
   ...
   mutau_analyzer(const char* file1, const char* file2, string isMC, string SampleName);
   ...
   void fillUncPlots( string histNumber, int eleIndex, int tauIndex, bool isFakeBkg,float event_weight);
   ...
   void applyEleESCorrections(TLorentzVector muP4, int muIndex,TLorentzVector& eleP4Corr);
   ...
   void setMyEleTau(int muIndex, int tauIndex);
   void resetTauTau(int eleIndex, int tauIndex);
...
void mutau_analyzer::setMyEleTau(int muIndex, int tauIndex){
  ...
  /// muon calibration sf
  /* double muCalibrationSF = 1.0; */
  /* double gen_mu_pt = 0; */
  /* int gen_mu_index = getGenMu(); */
  /* double randomN_01 = gRandom->Rndm(); */
  /* if(is_MC){ */
  /*   if (gen_mu_index>=0){ */
  /*     gen_mu_pt= mcPt->at(gen_mu_index); */
  /*     muCalibrationSF = rc.kSpreadMC(muCharge->at(muIndex) */
  /* 				     , muPt->at(muIndex) */
  /* 				     , muEta->at(muIndex) */
  /* 				     , muPhi->at(muIndex) */
  /* 				     , gen_mu_pt */
  ...
  /*   } */
  /*   else { */
  /*     muCalibrationSF = rc.kSmearMC(muCharge->at(muIndex) */
  /* 				    , muPt->at(muIndex) */
  /* 				    , muEta->at(muIndex) */
  /* 				    , muPhi->at(muIndex) */
  /* 				    , muTrkLayers->at(muIndex) */
  /* 				    , randomN_01 */
  /* 				    , 0, 0); */
  /*   } */
  /* } */
  /* else { */
  /*   muCalibrationSF = rc.kScaleDT(muCharge->at(muIndex) */
  /* 				  , muPt->at(muIndex) */
  /* 				  , muEta->at(muIndex) */
  /* 				  , muPhi->at(muIndex) */
  /* 				  , 0 , 0 ); */
  ...
  //my_muP4 = my_muP4 * muCalibrationSF;
  //cout<<"muCalibrationSF " <<muCalibrationSF<<endl;  

  if(is_MC){
    if (my_genmatching_l2>=5 && tau_DecayMode->at(tauIndex)==0) my_tauP4=my_tauP4*1.007;
    else if (my_genmatching_l2>=5 && tau_DecayMode->at(tauIndex)==1) my_tauP4=my_tauP4*0.998;
    else if (my_genmatching_l2>=5 && tau_DecayMode->at(tauIndex)==10) my_tauP4=my_tauP4*1.001;
    if ( (my_genmatching_l2==1 || my_genmatching_l2==3) && tau_DecayMode->at(tauIndex)==0) my_tauP4=my_tauP4*0.982;
    else if ( (my_genmatching_l2==1 || my_genmatching_l2==3) && tau_DecayMode->at(tauIndex)==1) my_tauP4=my_tauP4*1.018;
    if ( (my_genmatching_l2==2 || my_genmatching_l2==4) && tau_DecayMode->at(tauIndex)==0) my_tauP4=my_tauP4*0.998;
    else if ( (my_genmatching_l2==2 || my_genmatching_l2==4) && tau_DecayMode->at(tauIndex)==1) my_tauP4=my_tauP4*0.992;
  }
...
void mutau_analyzer::resetTauTau(int muIndex, int tauIndex){
