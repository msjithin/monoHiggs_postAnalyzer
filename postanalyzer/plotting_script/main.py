...
def main(hist, idx, ch, isblinded):
    ...
    bashCommandsA =  [ 
                    ...
                    "python postAnalyzer.py --hist {} --idx {} --blinded {}".format(hist, idx, isblinded),
                     ]
    bashCommandsB =  [      
                    ...
                    "python get_zll.py --hist {}".format(var_mapping[int(hist)]),
                    "python get_small_mc.py --hist {}".format(var_mapping[int(hist)]),
                    "python get_jetFakes.py --hist {} --blinded {}".format(var_mapping[int(hist)], isblinded),
                    "python get_jetFakes_unc.py --hist {} --blinded {}".format(var_mapping[int(hist)], isblinded),
                     ]
    bashCommandsC =  [ 
                    ...
                    "python get_jetFakes.py --hist {} --blinded {}".format(ch, isblinded),
                    "python get_jetFakes_unc.py --hist {} --blinded {}".format(ch, isblinded),
